...
public class EarthquakeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<ModelClass> earthquakes = new ArrayList<>();
        try {
            JSONObject root = new JSONObject(quakeReportJson);
            JSONArray featuresArray = root.getJSONArray("features");
            int i;
            for(i=0;i<featuresArray.length();++i)
            {
                JSONObject quakeArrayObject = featuresArray.getJSONObject(i);
                JSONObject properitesObject = quakeArrayObject.getJSONObject("properties");
        ...
        AdapterClass adapter = new AdapterClass(EarthquakeActivity.this,earthquakes);
